...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-full text-sm font-medium ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-clay-dark hover:shadow-glow",
        ...
        hero: "bg-primary text-primary-foreground hover:bg-clay-dark hover:shadow-glow px-8 py-4 text-base font-semibold hover:scale-[1.02]",
        pill: "bg-card text-foreground border border-border hover:bg-muted hover:border-primary/30",
        "pill-social": "bg-card text-foreground border border-border hover:bg-primary hover:text-primary-foreground hover:border-primary",
      },
      size: {
